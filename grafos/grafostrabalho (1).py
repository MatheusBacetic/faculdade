...
if not csv_files:
    ...
    # e sorteamos 70 entre eles para garantir a aleatoriedade solicitada
    ...
    print(f"[+] Arquivo 'grafo.txt' gerado com sucesso usando o CSV do Kaggle!")
    print(f"[+] Critério: Top 500 mais recomendados -> Amostra aleatória de 70")
